    ...
    <div className="min-h-screen">
      <main className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="animate-fade-in-up flex flex-col items-center text-center">
          <span className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-rose-500 to-amber-600 shadow-lg shadow-rose-500/30">
          ...
          <p className="inline-flex items-center gap-1.5 rounded-full bg-white/70 px-3 py-1 text-xs font-semibold uppercase tracking-widest text-rose-600 ring-1 ring-rose-200 backdrop-blur">
            <svg className="h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
              <path d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z" />
            </svg>
            AI-powered matching
          </p>
          <h1 className="mt-4 bg-gradient-to-br from-slate-900 via-rose-900 to-amber-800 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-base">
            ...
            <a
              className="font-medium text-rose-700 underline decoration-rose-300 underline-offset-2"
