...
export function AccountActions() {
  ...
  return (
    <section className="rounded-2xl border border-rose-200 bg-rose-50/50 p-5 sm:p-6">
      ...
      {confirming ? (
        <div className="mt-4 flex flex-wrap items-center gap-3">
          <span className="text-sm font-medium text-rose-900">Are you sure?</span>
          <button
            type="button"
        ...
        <button
          ...
          className="mt-4 rounded-lg border border-rose-300 bg-white px-4 py-2 text-sm font-semibold text-rose-700 shadow-sm transition hover:bg-rose-50"
        >
          Delete my account
        </button>
      )}
